<template>
  <div>
    <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight"
            aria-controls="offcanvasRight">Favourites
    </button>
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
      <div class="offcanvas-header">
        <h5 id="offcanvasRightLabel">Favourites</h5>
      ...
      <div class="offcanvas-body">
        ...
        <div class="card mb-3" v-for="(product, i) in favouriteProducts" :key="i">
          <div class="row">
            <div class="col-md-4">
              <img :src="'http://127.0.0.1:5173/public/images/' + product.image.substring(0, product.image.indexOf(','))"
